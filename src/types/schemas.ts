 ...
 * TODO: Schema.extend doesn't exist in current Effect Schema API
 * Need to implement using Schema.Struct and intersection types
 */
// export const extendSchema = <A, B>(
//   baseSchema: Schema.Schema<A>,
//   extension: Schema.Schema<B>
// ): Schema.Schema<A & B> => {
//   return Schema.extend(baseSchema, extension)
// }

/**
 * Make all fields in a schema optional
 * TODO: Schema.partial doesn't exist in current Effect Schema API
 * Need to implement using Schema.Struct with optional fields
 */
 ...
 * TODO: Schema.pick doesn't exist in current Effect Schema API
 * Need to implement using Schema.Struct with selected fields
 */
// export const pickFromSchema = <A, K extends keyof A>(
//   schema: Schema.Schema<A>,
//   ...keys: readonly K[]
// ): Schema.Schema<Pick<A, K>> => {
//   return Schema.pick(schema, ...keys)
// }

/**
 * Omit specific fields from a schema
 * TODO: Schema.omit doesn't exist in current Effect Schema API
 * Need to implement using Schema.Struct excluding specified fields
 */
// export const omitFromSchema = <A, K extends keyof A>(
//   schema: Schema.Schema<A>,
//   ...keys: readonly K[]
// ): Schema.Schema<Omit<A, K>> => {
//   return Schema.omit(schema, ...keys)
// }
