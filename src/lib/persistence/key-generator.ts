 ...
 */
export const SecureKeyGenerator = Context.GenericTag<KeyGenerator>(
  '@persistence/SecureKeyGenerator'
);
...
export const SecureKeyGeneratorLive = (
      ...
      return {
        generate: () =>
          Effect.gen(function* () {
            ...
            const randomBuffer = yield* Effect.sync(() =>
              randomBytes(finalConfig.length)
            );
 ...
 */
export const SimpleKeyGenerator = Context.GenericTag<KeyGenerator>(
  '@persistence/SimpleKeyGenerator'
);
