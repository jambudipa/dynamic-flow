 ...
 */
export const ConditionalOperatorService =
  Context.GenericTag<ConditionalOperatorService>('ConditionalOperatorService');
...
export const NestedConditionalOperatorService = Effect.gen(function* () {
  ...
  const service = {
    execute: (
      ...
      input: any,
      context: ExecutionContext
    ): Effect.Effect<any, OperatorError, never> =>
      Effect.gen(function* () {
