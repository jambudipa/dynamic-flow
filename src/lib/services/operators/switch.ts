 ...
 */
export class SwitchOperatorService extends Effect.Service<SwitchOperatorService>()(
  'SwitchOperatorService',
  {
    effect: Effect.gen(function* () {
      ...
      return {
        ...
        execute: (
          ...
          Effect.gen(function* () {
            ...
            const switchValue = yield* Effect.try(() => {
              ...
              if (
                typeof config.switch === 'string' &&
                config.switch.startsWith('$') &&
                context
              ) {
         ...
         */
        getDescription: () =>
          'Executes different branches based on switch value matching',
      };
    }),
  }
) {}
